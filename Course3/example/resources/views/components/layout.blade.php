    ...
    <body class="h-full color-black">
        <div class="min-h-full">
            ...
            <el-disclosure id="mobile-menu" hidden class="block md:hidden">
                ...
                <div class="border-t border-black pt-4 pb-3">
            ...
            <header class="relative bg-gray-800 after:pointer-events-none after:absolute after:inset-x-0 after:inset-y-0 after:border-y after:border-black">
